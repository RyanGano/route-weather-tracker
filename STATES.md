...
**Implementation note:** CDOT returns conditions by road *segment*, not by named pass.
...
*(reno and las-vegas added under California section above)*
...
*Next state to implement: Oregon (OR)*
